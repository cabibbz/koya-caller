    ...
    <Card>
      <CardHeader className="pb-3">
        <CardTitle className="text-sm font-medium text-muted-foreground">
          Call Outcomes This Month
        </CardTitle>
      </CardHeader>
      <CardContent>
        {total === 0 ? (
          <div className="text-center py-6 text-muted-foreground">
            <p className="text-sm">No calls yet this month</p>
            <p className="text-xs mt-1">Call outcomes will appear here once Koya handles calls</p>
          </div>
        ) : (
