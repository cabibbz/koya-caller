      ...
      <Card className="border-red-500/50 bg-red-500/5">
        <CardHeader className="pb-3">
          <div className="flex items-center gap-2">
            ...
            <CardTitle className="text-red-500">Minutes Exhausted</CardTitle>
          </div>
        </CardHeader>
        <CardContent className="space-y-4">
          <p className="text-sm text-muted-foreground">
            Koya is currently in message-only mode.
            <br />
            Callers cannot book appointments until you upgrade.
          </p>
          <Link href="/settings/billing">
            <Button className="w-full gap-2 bg-red-500 hover:bg-red-600">
              Upgrade Now to Restore Full Service
              <ArrowUpRight className="h-4 w-4" />
            </Button>
          </Link>
          <p className="text-xs text-muted-foreground text-center">
            Minutes reset in {daysUntilReset} days, or upgrade now for instant access.
          </p>
        </CardContent>
      </Card>
    );
        ...
        <div className="space-y-2">
          <div className="flex items-baseline justify-between">
            <div className="flex items-baseline gap-2">
              ...
              <span className="text-muted-foreground">/ {included} minutes used</span>
            </div>
          </div>
