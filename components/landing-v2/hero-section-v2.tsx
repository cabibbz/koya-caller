        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            >
              ...
              <br />
              <span className="text-shimmer">Another Call</span>
            </motion.h1>
            ...
            >
              Koya answers your phone 24/7, books appointments, and handles
              customer questions{" "}
              <span className="text-white">so you can focus on your business</span>.
            </motion.p>
            ...
            >
              ...
              <div className="text-sm">
                ...
                <p className="text-zinc-500">from 100+ businesses</p>
              </div>
            </motion.div>
          </div>
