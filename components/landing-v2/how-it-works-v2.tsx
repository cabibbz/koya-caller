...
const steps = [
  {
    number: "01",
    icon: Settings,
    title: "Tell Koya About Your Business",
    description:
      "Sign up and customize Koya with your services, hours, FAQs, and booking preferences.",
    duration: "~5 minutes",
  ...
  },
  {
    ...
    description:
      "Choose a new local number or forward your existing line. Koya starts answering immediately.",
    duration: "~2 minutes",
  ...
  },
  {
    number: "03",
    icon: MessageSquare,
    title: "Koya Handles Everything",
    description:
      "Koya answers calls 24/7, books appointments, and sends SMS confirmations automatically.",
    duration: "Forever",
...
function StepPreview({ step }: { step: (typeof steps)[0] }) {
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            ...
            <span className="text-sm text-zinc-300">Simple 3-step setup</span>
          </motion.div>
          ...
          <p className="text-lg text-zinc-400 max-w-2xl mx-auto">
            Get up and running in minutes, not weeks. No technical skills required.
          </p>
        </motion.div>
        ...
        >
          <div className="glass rounded-2xl p-8 max-w-xl mx-auto">
            <p className="text-zinc-400 mb-2">Ready to never miss a call again?</p>
