      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            ...
            <span className="text-sm text-zinc-300">Simple, transparent pricing</span>
          </motion.div>

          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4">
            <span className="text-white">Choose Your </span>
            <span className="text-shimmer">Perfect Plan</span>
          </h2>
                ...
                <div className="glass-light rounded-xl p-4 mb-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-zinc-500">minutes/month</p>
                    </div>
        ...
        >
          <p className="text-zinc-500 mb-6">
            No contracts. No overage fees. Cancel anytime.
          </p>
          ...
          <div className="flex flex-wrap items-center justify-center gap-8">
            {[
              ...
              { icon: MessageSquare, text: "Free onboarding" },
            ].map((item, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 10 }}
        ...
        >
          <div className="glass rounded-2xl p-6 md:p-8 text-center">
            <h3 className="text-xl font-bold text-white mb-2">
              Need more than 2,000 minutes?
            </h3>
            <p className="text-zinc-400 mb-4">
              Get custom pricing for high-volume businesses with dedicated support.
            </p>
