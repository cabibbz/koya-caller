...
import { Check, Sparkles, Brain, BookOpen, MessageSquare, Calendar } from "lucide-react";
...
export function LearningAnimation({
  ...
  // Generate learning items based on business type
  useEffect(() => {
        ...
        <AnimatePresence mode="popLayout">
          {items.map((item, index) => (
            ...
            >
              ...
              >
                {item.complete
                  ? item.text.replace("...", "").replace("Loading", "Loaded").replace("Adding", "Added").replace("Configuring", "Configured").replace("Optimizing", "Optimized")
                  : item.text}
              </span>
