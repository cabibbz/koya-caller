...
async function handlePost(
  ...
  try {
    ...
    const validTypes = ["appointment_reminder", "follow_up", "marketing", "custom"];
    if (!body.type || !validTypes.includes(body.type)) {
      return errors.badRequest("Campaign type must be: appointment_reminder, follow_up, marketing, or custom");
    }
