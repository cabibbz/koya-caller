...
async function CampaignContent({ campaignId }: { campaignId: string }) {
  ...
  // Fetch campaign from outbound_campaigns table
  ...
  // Extract settings for the component
  const settings = campaign.settings || {};
  const campaignData = {
    ...campaign,
    description: settings.description || null,
    custom_message: settings.custom_message || null,
    target_contacts: settings.contact_ids?.length || 0,
    scheduled_start: campaign.scheduled_at,
    scheduled_end: settings.scheduled_end || null,
    calls_completed: 0,
    calls_successful: 0,
    calls_declined: 0,
    calls_unsuccessful: 0,
  };
