...
import { LiveCallTracker } from "@/components/campaigns/live-call-tracker";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-start justify-between">
        <div>
          <Button variant="ghost" onClick={() => router.push("/outbound")} className="mb-4">
      ...
      {/* Live Call Tracker - Show for all non-draft campaigns */}
      {campaign.status !== "draft" && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              {campaign.status === "completed"
                ? "View call history and outcomes for this campaign"
                : "Real-time view of calls with live status updates"}
            </CardDescription>
          </CardHeader>
          <CardContent>
            <LiveCallTracker
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-yellow-600">{campaign.calls_declined}</p>
              </div>
              <PhoneOff className="h-8 w-8 text-yellow-500/30" />
            </div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-red-600">{campaign.calls_unsuccessful}</p>
              </div>
